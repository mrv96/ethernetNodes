...
const char PROGMEM mainPage[] =
    ...
    "<div id=page>"
        "<div class=inner>"
            "<div class=mast>"
                "<div class=title>esp8266<h1>ArtNet & sACN</h1>to<h1>DMX & LED Pixels</h1>"
                "</div>"
                "<ul class=nav>"
            ...
            "<div class='main section'>"
                ...
                "<div class=show name=sections>"
                    "<h2>Fetching Data</h2>"
                    "<p class=center>Fetching data from device. If this message is still here in 15 seconds, try refreshing"
                        "the page or clicking the menu option again."
                "</div>"
                ...
                "<div class=hide name=sections><input name=save type=button value='Save Changes' />"
                    ...
                    "<p class=right>In normal mode, the hotspot will start after <i>delay</i> seconds if the main WiFi won't"
                        "connect. If no users connect, the device will reset and attempt the main WiFi again. This feature is"
                        "purely for changing settings and ArtNet data is ignored."
                    "<p class=right>Stand alone mode disables the primary WiFi connection and allows ArtNet data to be"
                        "received via the hotspot connection."
                "</div>"
                "<div class=hide name=sections><input name=save type=button value='Save Changes' />"
                    "<h2>IP & Node Name</h2>"
                    ...
                    "<p class=center>These settings only affect the main WiFi connection. The hotspot will always have DHCP"
                        "enabled and an IP of <b>2.0.0.1</b>"
                "</div>"
                "<div class=hide name=sections><input name=save type=button value='Save Changes' />"
