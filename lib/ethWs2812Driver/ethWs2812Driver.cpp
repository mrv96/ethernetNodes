...
void ICACHE_RAM_ATTR ws2812Driver::doPixel(byte* data, uint8_t pin, uint16_t numBytes) {
  ...
  asm volatile (
    ...
    "doNextByteSingle:"
    "BEQZ   %[r_num_bytes], doExitSingle;"

    "L8UI   %[r_data], %[r_data_array], 0;"
    "ADDI.N %[r_data_array], %[r_data_array], 1;"
    "ADDI.N %[r_num_bytes], %[r_num_bytes], -1;"
    "MOVI %[r_bit], 0x80;"


    "sendNextBitSingle:"
    "BALL %[r_data], %[r_bit], doOne;"
    "j doZero;"


    "doNextBitSingle:"
    "SRLI %[r_bit], %[r_bit], 1;"
    "BEQZ %[r_bit], doNextByteSingle;"
    "j sendNextBitSingle;"

    "SingleLoop:"
    "RSR %[r_cc2], CCOUNT;"
    "BGE %[r_cc1], %[r_cc2], SingleLoop;"
    "j doNextBitSingle;"
    ...
    "SingleZeroLoop:"
    "RSR %[r_cc2], CCOUNT;"
    "BGE %[r_cc1], %[r_cc2], SingleZeroLoop;"
